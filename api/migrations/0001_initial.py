# Generated by Django 2.2 on 2020-01-01 17:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strategy', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='strategy_measure_information', to='api.Strategy')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=50, verbose_name='title')),
                ('description', models.TextField(verbose_name='description')),
                ('strategy_measure', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='threads', to='api.StrategyMeasureInformation', verbose_name='strategy_measure')),
