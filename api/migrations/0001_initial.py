# Generated by Django 2.2.7 on 2019-12-07 20:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='building_blocks/')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users_current_country', to='api.Country', verbose_name='current_country'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
