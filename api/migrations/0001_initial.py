# Generated by Django 2.2.7 on 2019-12-07 13:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_country', models.CharField(blank=True, choices=[('AFGHANISTAN', 'AFGHANISTAN')], max_length=50, null=True, verbose_name='current_country')),
        ...
        migrations.CreateModel(
            name='StrategyMeasureInformation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='updated')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ...
                ('strategy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='strategy_measure_information', to='api.Strategy')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='strategy',
            name='measures',
            field=models.ManyToManyField(blank=True, through='api.StrategyMeasureInformation', to='api.Measure', verbose_name='measures'),
        ),
        migrations.AddField(
            model_name='strategy',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='strategies', to=settings.AUTH_USER_MODEL, verbose_name='user'),
        ),
        migrations.CreateModel(
            name='Situation',
            fields=[
