...
class BuildingBlockThread(AbstractModel):
    ...
    strategy = models.ForeignKey('Strategy', related_name='building_block_threads', on_delete=models.CASCADE, verbose_name=_('strategy'))
    building_block = models.ForeignKey('BuildingBlock', related_name='building_block_threads', on_delete=models.CASCADE, verbose_name=_('building_block'))
